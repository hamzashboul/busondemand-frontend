    ...
    <div className="min-h-screen" style={{ backgroundColor: isDark ? '#0f1117' : '#f5f5f5' }}>
      ...
      <div className="max-w-2xl mx-auto py-8 px-4">
        ...
        <div className="rounded-xl p-4 mb-6 fade-in"
          style={{
            backgroundColor: isDark ? '#1a1d27' : '#f0f3fa',
            border: `1px solid ${isDark ? '#2d3748' : '#c7d2e8'}`
          }}>
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs text-gray-400">
                  {grouped[day].length === 0
                    ? t('noLectures')
                    : `${grouped[day].length} ${t('lectureCount')}`}
                </span>
              </div>
              ...
              {grouped[day].length === 0 ? (
                <div className="rounded-xl p-3 text-center"
                  style={{
                    ...
                    border: `1px dashed ${isDark ? '#2d3748' : '#e5e7eb'}`
                  }}>
                ...
                grouped[day].map(lecture => (
                  <div
                    key={lecture.id}
                    className="rounded-xl p-4 mb-2 flex items-center gap-3 card-hover"
                    style={{
                  ...
                  >
                    ...
                    <div className="text-xs px-2 py-1 rounded-full"
                      ...
                      {parseInt(lecture.end_time.slice(0, 2)) >= 12
                        ? isArabic ? 'م' : 'PM'
                        : isArabic ? 'ص' : 'AM'}
                    </div>
                  </div>
